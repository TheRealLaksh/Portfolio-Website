...
const chatData = {
    ...
    "projects": "Here is Laksh's project lineup:<br><br>1. <b>Portfolio Website</b>: 3D & Animated (You are here!)<br>2. <b>Stranger Things</b>: 3D Immersive Experience.<br>3. <b>Helios</b>: Aesthetic Web Music Player.<br>4. <b>CaliBridge</b>: JS Event Calendar.<br>5. <b>Artist Portfolio</b>: Minimalist site for actors.<br>6. <b>MVP Webstore</b>: Frontend E-commerce demo.<br><br>Check the code on <a href='https://github.com/TheRealLaksh' target='_blank' class='text-sky-400 underline'>GitHub</a>!",
